...
import comentariosRoutes from "../src/comentario/comentario.routes.js";
...
class Server {
  constructor() {
    ...
    this.comentariosPath = '/GestorOpiniones/v1/comentarios/:idPublicacion';
  ...
  routes(){
    ...
    this.app.use(this.comentariosPath, comentariosRoutes); 
